    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center max-w-4xl mx-auto px-6">
        <div className="animate-fade-in">
          <h1 className="font-display text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-6 drop-shadow-lg px-4">
            {t('hero.title')}
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-white mb-8 drop-shadow-md font-light px-4">
            {t('hero.subtitle')}
          </p>
          <Button
